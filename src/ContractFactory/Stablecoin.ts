...
export interface Stablecoin extends BaseContract {
  ...
  filters: {
    ...
    "Burn(uint256)"(amount?: BigNumberish | null): BurnEventFilter;
    Burn(amount?: BigNumberish | null): BurnEventFilter;

    "Mint(uint256)"(amount?: BigNumberish | null): MintEventFilter;
    Mint(amount?: BigNumberish | null): MintEventFilter;
